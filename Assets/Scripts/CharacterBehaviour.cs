...
//         [Range(0, 1)] [SerializeField] private float m_CrouchSpeed = .36f;  // Amount of maxSpeed applied to crouching movement. 1 = 100%
        ...
        [SerializeField] private float m_SlashTime = 0.5f;                  // Length of time slash is active
        [SerializeField] private float m_DashTime = 0.5f;
        [SerializeField] private float m_DashSpeed = 50f;
        [SerializeField] private float m_AttackCooldownTime = 0f;               // Cooldown time between attacks
